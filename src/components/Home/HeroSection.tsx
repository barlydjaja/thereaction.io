...
const PROJECTS = [
  ...
  { name: 'Gravity (Anti)', desc: 'Creative UI Engineering', url: 'https://gravity.thereaction.io' },
  { name: 'Heavy', desc: 'Weightlift Tracker app', url: 'https://heavy.thereaction.io' },
];
        ...
        {PROJECTS.map((project, i) => (
          ...
          >
            ...
            <div className="w-full aspect-[4/3] rounded-xl bg-[--text]/5 mb-5 overflow-hidden relative">
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-[--text]/20">
                  ...
                  <span className="text-xs font-semibold uppercase tracking-widest">Image Space</span>
                </div>
              </motion.div>
            ...
            <div className="relative z-10 flex flex-col px-1 pb-1">
              ...
              <p className="text-sm text-[--text]/60 leading-relaxed">{project.desc}</p>
            </div>
          </motion.a>
        ))}
      </div>
